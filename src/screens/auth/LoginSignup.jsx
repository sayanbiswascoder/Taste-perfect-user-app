...
const LoginSignupScreen = ({ navigation }) => {
    ...
    const handleLogin = () => {
        axios.post('http://192.168.231.252:3000/api/auth/logIn', {
            type: 'users',
            email,
            password,
        }).then((response) => {
    ...
    const handleSignup = () => {
        axios.post('http://192.168.231.252:3000/api/auth/signUp', {
            type: 'users',
            name,
            email,
            mobile,
    ...
    const handleForgetPassword = async () => {
        if (email) {
          axios.post('http://192.168.231.252:3000/api/auth/forgetPassword', {
            type: 'users',
            email: email,
          }).then((response) => {
            if(response.status === 200){
